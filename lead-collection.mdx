...
[​](https://guide-chatwize.com/lead-collection#collecting-data-through-a-form)
...
[​](https://guide.Chatwize.com/lead-collection#collecting-data-conversationally)
...
### [​](https://guide.Chatwize.com/lead-collection#editing-the-prompt)&#xA;Editing the prompt
...
- **Step 1**: When engaging with the user for the first time, politely ask for their first name.  
  Example: "May I know your first name, please?"
  
- **Step 2**: Once the user provides their first name, proceed to collect their contact information.  

  - **Ask for their mobile telephone number**:  
    Example: "Thank you! Could you also share your mobile number for further communication?"

  - **Ask for their e-mail address**:  
    Example: "Finally, may I have your e-mail address so we can send important updates?"

- **Step 3**: If the user is not comfortable providing any particular piece of information, respect their decision.  
  Example: "No problem at all! Feel free to share only what you're comfortable with."
...
### [​](https://guide.Chatwize.com/lead-collection#setting-up-variables)&#xA;Setting up variables
...
[​](https://guide.Chatwize.com/lead-collection#sending-data-to-your-crm)
Sending data to your CRM
------------------------

Regardless of whether you want to collect data using a form or conversationally, you may wish to send that information to another CRM for follow up. Chatwize supports webhooks with smart triggers that can alert you to new leads as soon as they engage with the AI.
...
[​](https://guide-chatwize.com/lead-collection#sending-data-by-email)
