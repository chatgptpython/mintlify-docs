...
Chatwize is the first and most powerful LLM-native conversational AI platform that
...
Chatwize has 2 types of Agents:
...
<AccordionGroup>
  <Accordion title="Chatwize Assistant">
  ...
  <Accordion title="Unrelated Query Defender">
    The Unrelated Query Defender Agent handles any user queries not related to Chatwize. This includes requests for:
    - writing assistance
