...
[​](https://guide-chatwize.com/multi-agents-chatbot#debugging-the-chatbot)
...
To learn some best practices for training the chatbot, see [best practices for preparing training data](https://guide-chatwize.com/best-practices)

To learn more about fine-tuning Agent intents, please check out the article [Fine-Tuning Agent Intents](https://guide-chatwize.com/fine-tuning-agent-intents).
