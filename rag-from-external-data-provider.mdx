...
description: "RAG from an External Data Provider explains how to enrich your chatbot’s knowledge using real-time data via API and function-calling in Chatwize."
---
...
or updated in real-time? There is no way to dump the entire database into Chatwize’s static knowledge library and still maintain a live link…

This is where function-calling comes in. Through function-calling, you can serve data on-demand to your AI Agent in Chatwize during a live
...
In your chatbot inside Chatwize, you must first create an appropriate AI Agent that you plan to give this function-calling capability to. In our example,
...
implement and host your own database search function that then gets integrated with Chatwize.