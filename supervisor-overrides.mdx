...
description: "AI Supervisor Overrides lets you define logic rules in Chatwize to control which AI Agent takes over based on conditions you specify."
---

If you have a multi-Agent chatbot setup, Chatwize uses an AI Supervisor to automatically
