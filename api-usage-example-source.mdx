...
The API endpoint for uploading data sources to your chatbot is: `https://app-chatwize.com/api/v1/chatbot/{uuid}/data-source/url`.
...
url = 'https://app-chatwize.com/api/v1/chatbot/{uuid}/data-source/url'
headers = {
