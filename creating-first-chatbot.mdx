...
To get started, first log in to your account. If this is your first time using GPT-trainer, you will be asked to complete some initial onboarding steps. Afterwards, you will be presented with the ability to build an AI chatbot from one of our templates:
...
![](create-chatbot-15.png)These personas have been predefined with a number of use-case-specific customizations, so they work out of the box, for the most part. Each persona has a different setup flow, but all of them should be very easy to follow.
...
Close the chatbot testing tab. You will return to GPT-trainer’s main interface. Go through the onboarding guide to learn more about your options.
