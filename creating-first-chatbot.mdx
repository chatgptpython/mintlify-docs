...
description: "Create Your First Chatbot with Chatwize by logging in and following a simple onboarding flow to launch your first AI assistant from a template."
---
